...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmittedLink.email'
        db.add_column(u'search_submittedlink', 'email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmittedLink.email'
        db.delete_column(u'search_submittedlink', 'email')
