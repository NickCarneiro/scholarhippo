...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scholarship.street_address'
        db.add_column(u'search_scholarship', 'street_address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Scholarship.date_added'
        db.alter_column(u'search_scholarship', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Scholarship.street_address'
        db.delete_column(u'search_scholarship', 'street_address')


        # Changing field 'Scholarship.date_added'
        db.alter_column(u'search_scholarship', 'date_added', self.gf('django.db.models.fields.DateField')())
